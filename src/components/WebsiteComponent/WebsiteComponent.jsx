...
{/* Header Section*/}
        <nav className="w-full flex-row justify-between items-center md:flex">
          <div className="flex flex-row max-sm:justify-center max-md:justify-center items-center gap-5 lg:gap-8 xl:gap-10 text-2xl xl:text-3xl">
            <a href="#home"><img src= {logo} alt="logo" className="w-[40px] my-2 rounded-full overflow-hidden shadow-[0_5px_2px_0px_rgba(0,0,0,0.3)] shadow-black"></img></a>
            <p>Injective Degens</p>
          </div>
          
          <div className="flex flex-row justify-between items-center max-sm:hidden lg:gap-8 md:gap-6 xl:gap-10">
            <a href="#about" className="underline decoration-yellow-500">About</a>
            <a href="#disclaimer" className="underline decoration-yellow-500">Legal Disclaimer</a>
            <Link to='/project' className="underline decoration-yellow-500">Buy Now</Link>
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center w-full md:pt-8 lg:pt-12 xl:pt-16">
          <div className="flex flex-col items-center lg:items-start justify-start gap-8 m-[40px_0px] max-sm:m-[20px_0px]">
            ...
            <div className="flex flex-col md:flex-row gap-3 lg:gap-5 xl:gap-7 items-center mt-0 lg:mt-6 xl:mt-8">
              <a href="https://t.me/injectiveDgnz" target="_blank" rel="noopener noreferrer" className="border-2 bg-yellow-400 hover:bg-yellow-500 text-black border-b max-sm:w-full shadow-[0_5px_2px_0px_rgba(0,0,0,0.3)] shadow-black text-center text-3xl max-sm:text-2xl xl:text-4xl transition-all duration-500 rounded-xl lg:rounded-2xl py-2 px-3 max-sm:px-3 max-sm:py-1 hover:-translate-y-1">TELEGRAM</a>

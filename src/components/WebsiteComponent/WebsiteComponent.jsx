...
{/* Header Section*/}
        <nav className="w-full flex-row justify-between items-center md:flex">
          <div className="flex flex-row justify-between items-center gap-5 lg:gap-8 xl:gap-10 text-2xl xl:text-3xl">
            <img src= {logo} alt="logo" className="w-[40px] rounded-full overflow-hidden shadow-[0_5px_2px_0px_rgba(0,0,0,0.3)] shadow-black"></img>
            <p>Injective Degens</p>
              
          </div>
          <div className="flex flex-row justify-between items-center gap- lg:gap-8 xl:gap-10">
            <a href="#about">About</a>
            <a href="#disclaimer">Legal Disclaimer</a>
            <Link to='/project'><a href="">Buy Now</a></Link>
...
{/*About Section*/}
        <div id='about' className='about m-[40px_0px] p-5 border rounded-xl'>
          <h2 className='text-4xl font-bold'>ABOUT INJECTIVE DEGENS</h2>
          <p>
...
{/* Tokenomics section */}
        ...
        <h2 className='text-4xl underline font-bold'>$TOKENOMICS</h2>
...
{/* Roadmap Section */}
        <div className='m-[40px_0px] text-left p-5 border rounded-xl'>
        <h2 className='text-4xl underline font-bold'>ROADMAP</h2>
          <h3>Q1</h3>
          <ul>
...
{/* Disclaimer Section */}
        <div id='disclaimer' className='disclaimer m-[40px_0px] p-5 border rounded-xl'>
          <h2 className='text-4xl font-bold'>LEGAL DISCLAIMER</h2>
          <p>

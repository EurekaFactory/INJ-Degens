      ...
      <main id="home" className="text-2xl max-sm:mx-0 max-sm:text-lg">
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center w-full md:pt-8 lg:pt-12 xl:pt-16">
          <div className="flex flex-col items-center lg:items-start justify-start gap-8 m-[40px_0px] max-sm:m-[20px_0px]">
            <h1 className="font-bold text-7xl max-sm:text-5xl md:text-6xl lg:text-9xl xl:text-8xl">
              INJECTIVE DEGENS
            </h1>
            <h3 className=" text-3xl md:text-4xl lg:text-5xl xl:text-5.5xl leading-none text-center md:text-left">
              DEGENS WILL DEGEN
            </h3>
        ...
        <div className="m-[40px_0px] p-5 border rounded-xl">
          ...
          <p>
            $Dgnz is created by degens for degens. Our vision is to establish a
            strong foundation for crypto enthusiasts on Injective. Degen Dao
            will thus be created to formulate and accelerate this growth.
          </p>
        </div>

        {/* Tokenomics section */}
        <div className="m-[40px_0px] text-left p-5 border rounded-xl">
          <h2 className="text-4xl max-sm:text-2xl max-sm:text-center underline font-bold">
            $TOKENOMICS
          </h2>
        ...
        <div className="m-[40px_0px] text-left p-5 border rounded-xl">
          ...
          <ul>
            <li>
              * Token Drop and NFT mint. Colabs with projects. Airdrops for
              Holders. Establish the Degen Dao.
            </li>
          </ul>
        ...
        <div
          id="disclaimer"
          className="disclaimer m-[40px_0px] p-5 border rounded-xl"
        >
          <h2 className="text-4xl max-sm:text-2xl font-bold">
            LEGAL DISCLAIMER
          </h2>
          <p>
            <strong>
              It is requested to read this legal disclaimer section with full
              attention.
            </strong>
            <br></br>
            In any doubt, the consultancy shall be taken from the legal,
            financial, tax, or other professional law practitioners. All the
            information given below is not presented exhaustively and can never
            be considered part of various contractual relationships. We desire
            that the information provided in this white paper should be
            accurate, up to date, and all the products, services, technical
            architecture, coin distribution, and company timelines remain
            static. All materials are subject to change without notice, and they
            cannot be considered a binding agreement of professional advice.
            This white paper does not bind any individual to enter into any
            contract or enter into any binding legal commitment to the
            contribution. This white paper also does not have any capacity to
            bind any person to enter into any contract or consider it a binding
            legal obligation to the assistance of the whitepaper. As a result of
            this publication, distribution, dissemination does not imply the
            applicable laws, the regulatory requirements, and the available
            regulations.
          </p>
        </div>
        ...
        {/* Contact */}
        <div className="m-[40px_0px] text-left p-5 border rounded-xl">
          <h2 className="text-4xl max-sm:text-2xl text-center font-bold">
            CONTACT INFORMATION
          </h2>
